...
public class CardUpcommingBindingImpl extends CardUpcommingBinding  {
    ...
    public CardUpcommingBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 7, sIncludes, sViewsWithIds));
    }
    private CardUpcommingBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    protected void executeBindings() {
        ...
        java.lang.String presenterGetPrimaryTextItem = null;
        ...
        if ((dirtyFlags & 0x7L) != 0) {
            ...
            if ((dirtyFlags & 0x5L) != 0) {
                ...
                if (presenter != null) {
                    ...
                    // read presenter.getPrimaryText(item)
                    presenterGetPrimaryTextItem = presenter.getPrimaryText(item);
                }
        }
        // batch finished
        if ((dirtyFlags & 0x7L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.corse, presenterGetPrimaryTextItem);
